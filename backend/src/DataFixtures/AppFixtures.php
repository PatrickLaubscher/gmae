...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $_PARTNERS = [
            [
                'name' => 'ALLIA',
                'description' => "ALLIA accompagne les entreprises dans leurs démarches en termes d’assurance. Cette société se spécialise dans la fourniture de solutions d'assurance sur mesure, adaptées aux besoins spécifiques de chaque entreprise, qu'elle soit une petite start-up ou une grande multinationale.
            ...
            [
                ...
                'description' => "LES + MUTUALISTES finance la solidarité nationale.
                ...
                'logo' => 'les-mutualistes.png',
            ],
            [
                'name' => 'OCAR',
                'description' => "OCAR est une compagnie d’assurance qui est présente sur tout le territoire.
            ...
            [
                'name' => 'Assurisk',
                'description' => "Être bien couvert, votre objectif et notre mission.
        ...
        foreach($_SERVICES as $servicedata) {
            $service = new Service();
        ...
        foreach($_PARTNERS as $partnerData) {
            $partner = new Partner();
            $partner->setName($partnerData['name']);
            $partner->setDescription($partnerData['description']);
            $partner->setLogo($partnerData['logo']);
             foreach($services as $service) {
                if(str_contains($partnerData['description'], $service->getName())) {
