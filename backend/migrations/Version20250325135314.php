...
{
    // Vérifier si la table 'partner' existe déjà
    ...
    // Vérifier si la table 'partner_service' existe déjà
    if (!$schema->hasTable('partner_service')) {
    ...
    // Vérifier si la table 'service' existe déjà
    ...
    // Vérifier si la contrainte FK_2677F9CF9393F8FE existe déjà avant d'ajouter la contrainte
    $this->addSql('
        CREATE TABLE IF NOT EXISTS partner_service (
            partner_id INT NOT NULL, 
            service_id INT NOT NULL, 
            INDEX IDX_2677F9CF9393F8FE (partner_id), 
            INDEX IDX_2677F9CFED5CA9E6 (service_id), 
